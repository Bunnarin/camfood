...
urlpatterns = [
    ...
    path('purchase/detail/<int:pk>', views.PurchaseDetailView.as_view(), name='detail_purchase'),
    # material
    ...
    path('supplier/<int:pk>/', views.SupplierDetailView.as_view(), name='detail_supplier'),
